...
class beam_fem:
    ...
    def assemble_glb_mtx(self, type = 'stiff', alpha1 = 0.0, alpha2 = 0.0, alpha3 = 0.0):
        ...
        ele_node = np.hstack((ele_num*2, ele_num*2+1, ele_num*2+2, ele_num*2+3))
    ...
    def frequency(self,order,alphas = [0.0,0.0,0.0]):
        ...
        M = self.assemble_glb_mtx(type = 'mass')
        K = self.assemble_glb_mtx(type = 'stiff', alpha1 = alphas[0], alpha2 = alphas[1], alpha3 = alphas[2])
